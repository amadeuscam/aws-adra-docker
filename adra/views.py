...
from .forms import (AlimentosFrom, HijoForm, PersonaForm,
                    ProfileEditForm, UserEditForm)
from .models import Persona, Alimentos, AlmacenAlimentos, Hijo
from .serializers import (
    PersonaSerializer, AlacenAlimentosSerializer, UserSerializer)
    ...
    def form_valid(self, form):
        ...
        if "alimento_1" in clean:
            ...
            if form.instance.alimento_1 > valor_anterior_alimento_1:
                restante = abs(form.instance.alimento_1 -
                               valor_anterior_alimento_1)
        ...
        if "alimento_2" in clean:
            ...
            if form.instance.alimento_2 > valor_anterior_alimento_2:
                restante = abs(form.instance.alimento_2 -
                               valor_anterior_alimento_2)
        ...
        if "alimento_3" in clean:
            ...
            if form.instance.alimento_3 > valor_anterior_alimento_3:
                restante = abs(form.instance.alimento_3 -
                               valor_anterior_alimento_3)
        ...
        if "alimento_4" in clean:
            ...
            if form.instance.alimento_4 > valor_anterior_alimento_4:
                restante = abs(form.instance.alimento_4 -
                               valor_anterior_alimento_4)
        ...
        if "alimento_5" in clean:
            ...
            if form.instance.alimento_5 > valor_anterior_alimento_5:
                restante = abs(form.instance.alimento_5 -
                               valor_anterior_alimento_5)
        ...
        if "alimento_6" in clean:
            ...
            if form.instance.alimento_6 > valor_anterior_alimento_6:
                restante = abs(form.instance.alimento_6 -
                               valor_anterior_alimento_6)
        ...
        if "alimento_7" in clean:
            ...
            if form.instance.alimento_7 > valor_anterior_alimento_7:
                restante = abs(form.instance.alimento_7 -
                               valor_anterior_alimento_7)
        ...
        if "alimento_8" in clean:
            ...
            if form.instance.alimento_8 > valor_anterior_alimento_8:
                restante = abs(form.instance.alimento_8 -
                               valor_anterior_alimento_8)
        ...
        if "alimento_9" in clean:
            ...
            if form.instance.alimento_9 > valor_anterior_alimento_9:
                restante = abs(form.instance.alimento_9 -
                               valor_anterior_alimento_9)
        ...
        if "alimento_10" in clean:
            ...
            if form.instance.alimento_10 > valor_anterior_alimento_10:
                restante = abs(form.instance.alimento_10 -
                               valor_anterior_alimento_10)
        ...
        if "alimento_11" in clean:
            ...
            if form.instance.alimento_11 > valor_anterior_alimento_11:
                restante = abs(form.instance.alimento_11 -
                               valor_anterior_alimento_11)
        ...
        if "alimento_12" in clean:
            ...
            if form.instance.alimento_12 > valor_anterior_alimento_12:
                restante = abs(form.instance.alimento_12 -
                               valor_anterior_alimento_12)
    ...
    if 'q' in request.GET and request.GET['q']:
        ...
        if ultima_persona:
            ...
            beneficiarios_no_activos = Persona.objects.filter(
                active=False).order_by("-numero_adra")
            return render(request, 'adra/no_beneficiarios.html',
...
def statistics_persona(request):
    ...
    if int(mod) == 1:
        beneficiar = Persona.objects.prefetch_related(
            'hijo').filter(active=True).exclude(covid=True)
    else:
        beneficiar = Persona.objects.prefetch_related(
            'hijo').filter(active=True)
    ...
    [lst_02_mujer.append(b.age) for b in beneficiar if 0 <=
     b.age <= 2 and b.sexo == "mujer"]
    [lst_02_hombre.append(b.age) for b in beneficiar if 0 <=
     b.age <= 2 and b.sexo == "hombre"]

    [lst_3_15_mujer.append(b.age) for b in beneficiar if 3 <=
     b.age <= 15 and b.sexo == "mujer"]
    [lst_3_15_hombre.append(b.age) for b in beneficiar if 3 <=
     b.age <= 15 and b.sexo == "hombre"]

    [lst_16_64_mujer.append(b.age) for b in beneficiar if 16 <=
     b.age <= 64 and b.sexo == "mujer"]
    [lst_16_64_hombre.append(b.age) for b in beneficiar if 16 <=
     b.age <= 64 and b.sexo == "hombre"]

    [lst_64_mujer.append(b.age)
     for b in beneficiar if b.age >= 65 and b.sexo == "mujer"]
    [lst_64_hombre.append(b.age)
     for b in beneficiar if b.age >= 65 and b.sexo == "hombre"]

    lst_familiares = []
    for hijo in beneficiar:
        [
            (lst_02_mujer.append(b.age),
             lst_familiares.append(b.age)) for b in hijo.hijo.all() if
    ...
    data_statistics = {
        ...
        "total_mujeres": len(lst_02_mujer) + len(lst_3_15_mujer) +
        len(lst_16_64_mujer) + len(lst_64_mujer),
        ...
        "total_hombres": len(lst_02_hombre) + len(lst_3_15_hombre) +
        len(lst_16_64_hombre) + len(lst_64_hombre),
        ...
        "total_personas": len(lst_02_mujer) + len(lst_02_hombre) +
        len(lst_3_15_mujer) + len(lst_3_15_hombre) + len(
            lst_16_64_mujer) + len(lst_16_64_hombre) + len(lst_64_mujer) +
        len(lst_64_hombre),
...
def telegram_messages(request):
    ...
    if dom and mensaje_propio:
        bot = telegram.Bot(
            token='1103551052:AAEUecilMN5Eku3b46NA-_Q2Ba_K7QvV7dg')
        # print(bot.getUpdates())
        persona = Persona.objects.filter(active=True).filter(
...
def export_users_csv(request):
    beneficiarios_queryset = Persona.objects.order_by(
        'numero_adra').filter(active=True)
...
class CustomAllauthAdapter(DefaultAccountAdapter):
    """
    Clase encarcada de enviar emails custom
    """
